        ...
        <div className={`${style.admin_create_barber_wrapper_right}`}>
          ...
          {/* <div className={`${style.admin_create_barber_content_wrapper_right}`}>
            <div className={`${style.service_item}`}>
              <div className={`${style.service_item_top}`}>
                <div><img src="https://cdn.pixabay.com/photo/2024/05/26/10/15/bird-8788491_1280.jpg" alt="service icon" /></div>
                <div>
                  <p>Braides and Fades</p>
                  <p>Each haircut begins with a complete consultation and hair analysis, followed by a magnificent shampoo and relaxing scalp massage.</p>
                </div>
              </div>
              <div className={`${style.service_item_bottom}`}>
                <div>
              ...
              <div className={`${style.service_add_icon}`}><AddIcon /></div>
            </div>
          </div> */}
